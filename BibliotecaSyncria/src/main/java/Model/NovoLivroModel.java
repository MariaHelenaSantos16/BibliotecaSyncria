...
public class NovoLivroModel {
    ...
    public NovoLivroModel(int idLivro, String tituloObra, int numeroCopias, String dataCadastro, String generosLiterarios, String subgenerosLiterarios, String autor, int numeroRegistro, String edicao, int volume, String localizacao, String editora, int anoFabricacao, int anoPublicacao, String aquisicao, String exemplar, String numeroChamada, String isbn, String status, String observacoes, int quantidadeTituloEmprestado, int quantidadeTituloAcervo) {
    ...
    public void setTituloDaObra(String text) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    public void setAnoDePublicacao(String text) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    public void setGeberoLiterario(String string) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
    ...
    public void setSubegenero(String text) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    public void setnDeChamada(String text) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    public void setnDeCopia(String string) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    public void setnDeRegistros(String text) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
